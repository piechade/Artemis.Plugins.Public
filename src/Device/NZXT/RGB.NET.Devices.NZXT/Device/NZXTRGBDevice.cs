...
{
    public class NZXTRgbDevice : AbstractRGBDevice<NZXTRgbDeviceInfo>, IMouse, IMousepad
    {
        internal NZXTRgbDevice(NZXTRgbDeviceInfo info, IUpdateQueue updateQueue, int ledCount)
